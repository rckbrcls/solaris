...
struct PhotoEditorHelper {
    ...
    static func editOptionIcon(for option: String) -> String {
        ...
        case "sharpen", "sharpness": return "wand.and.stars"
        case "clarity": return "viewfinder.circle"
        case "colorInvert": return "arrow.triangle.2.circlepath"
        case "pixelateAmount": return "rectangle.split.3x3"
        case "colorTint": return "paintpalette"
        case "skinTone": return "person.crop.circle"
